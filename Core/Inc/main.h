...
#define ANALOG_GAMEPAD_R2_Pin GPIO_PIN_6
#define ANALOG_GAMEPAD_R2_GPIO_Port GPIOA
#define ANALOG_GAMEPAD_L2_Pin GPIO_PIN_7
#define ANALOG_GAMEPAD_L2_GPIO_Port GPIOA
